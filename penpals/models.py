""" Models for the Penpal aplication """
...
class PenpalProfile(models.Model):
    ...
    pronoun = models.CharField(max_length=50,
                               ...
                               default="Your preferred pronoun/s)")
    age = models.IntegerField(blank=True, null=True)
    country = CountryField(null=False, blank=False)
    hobby1 = models.CharField(max_length=50,
                              null=False, blank=False,
                              default="Something you enjoy")
    ...
    email = models.EmailField(max_length=50, null=False,
                              blank=False, default="Your email address")

    user = models.OneToOneField(User, on_delete=models.CASCADE,
                                null=True, related_name='penpal')
